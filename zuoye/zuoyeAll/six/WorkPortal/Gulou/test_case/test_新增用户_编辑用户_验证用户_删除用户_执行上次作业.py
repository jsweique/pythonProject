...
from zuoye.zuoyeAll.six.WorkPortal.Gulou.business.用户中心_business import UserCenter
from zuoye.zuoyeAll.six.WorkPortal.Gulou.business.登录_business import Login
from zuoye.zuoyeAll.six.WorkPortal.Gulou.business.首页_business import Home
from zuoye.zuoyeAll.six.WorkPortal.Gulou.config.browser import Browser
from zuoye.zuoyeAll.six.WorkPortal.Gulou.data.testdata import get_csv_data
...
class TestLogin(unittest.TestCase):
    ...
    # 类属性
    # 注意:!!!! 数据路径  不一样！！！
    csv_file=r"E:\WorkPortal\Gulou\data\account_login_gulou.csv"
    # 测试用例运行之前的准备工作
    def setUp(self):
        print("开始测试~~~~~~")
        # 忽略下警告
